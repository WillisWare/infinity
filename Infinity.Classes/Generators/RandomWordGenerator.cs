...
namespace Infinity.Classes.Generators
{
    ...
    public class RandomWordGenerator
    {
        ...
        public static string Word(int syllables, bool filter, bool properCase = true)
        {
            ...
            var textInfo = new CultureInfo(CultureInfo.CurrentUICulture.Name).TextInfo;

            return properCase ? textInfo.ToTitleCase(word) : word;
        }
